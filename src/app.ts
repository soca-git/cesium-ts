...
import "./app.css";
import { ArcType, Cartesian3, Cartographic, Color, CorridorGraphics, EllipsoidGeodesic, EllipsoidRhumbLine, Entity, PointGraphics, PolylineDashMaterialProperty, PolylineGraphics } from "cesium";
